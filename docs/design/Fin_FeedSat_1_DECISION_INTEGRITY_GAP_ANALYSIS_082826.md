# Fin_FeedSat_1 Decision Integrity and Design Gap Analysis
...
Fin_FeedSat_1 v1 is limited to U.S. stocks, exchange-traded funds (ETFs), and published market indices. Stocks and ETFs may be tradable subject to reference data and risk approval. Indices are analytics-only calculated series and cannot be routed directly as broker orders.
