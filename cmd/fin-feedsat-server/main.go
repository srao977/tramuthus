...
func main() {
	...
	finfeedsatv1.RegisterMarketFeedServiceServer(grpcServer, feedSatServer)
	finfeedsatv1.RegisterIngestionServiceServer(grpcServer, feedSatServer)
	finfeedsatv1.RegisterOperationsServiceServer(grpcServer, feedSatServer)
	finfeedsatv1.RegisterModelServiceServer(grpcServer, feedSatServer)
	finfeedsatv1.RegisterSemanticServiceServer(grpcServer, feedSatServer)
