# Fin_FeedSat_1 Go D04 Scientific Baseline
...
| Field | Value |
| :--- | :--- |
| Path | `C:\Users\chino\Fin_FeedSat_1` |
...
Observed live 2 Sep 2026 on IEX (AAPL / MSFT / NVDA) through `Fin_FeedSat_1-dashboard` Adaptive Pipeline. Example: AAPL accepted sequence 20 at 2:01 PM ET, Departures CLEARED (BUY / Upward / scientific LONG) while Price Engine still BOARDING (minute 20 of 45).
...
| P-04 Price Engine | EXISTING ONLY in this tree (already landed 2 Sep; **not modified by this freeze**). Default `FIN_FEEDSAT_PRICING=off`. |
...
| :--- | :--- | :--- |
| `FIN_FEEDSAT_MODEL` | `off` | `adaptive` |
| `FIN_FEEDSAT_PRICING` | `off` | `expm` (opt-in; not required for this D04 freeze) |
| `FIN_FEEDSAT_MODEL_DEADLINE` | `200ms` | default |
| `Fin_FeedSat_1_SOURCE` | — | `alpaca` |
| `Fin_FeedSat_1_FEED` | — | `iex` |
| `Fin_FeedSat_1_SYMBOLS` | — | `AAPL,MSFT,NVDA` |
...
`docs/design/Fin_FeedSat_1_go_d04_baseline_inventory_090226.sha256.txt`  
...
| `api/proto/Fin_FeedSat_1/v1/Fin_FeedSat_1.proto` | `34651eced569fed9db4969c0a9627e2629b115d4f32b4de8f07d3a202a625b77` |
| `cmd/fin-feedsat-server/main.go` | `7a445f2a918d7d9a2d4c1d05a7e6f6bcbe5d2721b43ad4f18a2efd72abf8d059` |
...
`Fin_FeedSat_1-go-d04-pre-interval-fix-2026-09-02`

Tag message intent:

> Fin_FeedSat_1 Go D04 scientific/runtime baseline before interval-aware continuity changes. Includes accepted Go adaptive path through D01, D02, D04 and Emitter. Known issue: nominal one-minute timestamp non-adjacency may incorrectly produce INPUT_GAP / STATE_DISCONTINUOUS for legitimate irregular provider observations. This tag intentionally preserves that behavior for regression comparison.
...
- `bin/`, `fin-feedsat-server.exe` (local binaries)
