...
import (
	...
	"fin_feedsat_1/internal/semantics/tooling"
)
...
func usage() {
	fmt.Fprint(os.Stderr, `fin-feedsat-semantics validate [json]
fin-feedsat-semantics audit [repo-root]
fin-feedsat-semantics build [--check] [json]
`)
}
